...
class PlayerSpawn : NSObject, AVAudioPlayerDelegate {
    ...
    let shipSprite:SKSpriteNode = SKSpriteNode(imageNamed: "player1_blue")
    ...
    func addShipToParent(_ parent:SKNode, pos:CGPoint) -> Void {
        ...
        let spTexture = SKTexture(imageNamed: "player1_blue")
        ...
        shipSprite.name = PlayerSpawn.SpriteName()
